...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/KCnoMM2.jpg Hey {sender}, I'm ♡༻𝔞𝔩𝔢𝔪𝔞𝔭༺♡ 𝙹𝚎𝚊𝚗 𝙿𝚊𝚛𝚔𝚎𝚛's daughter \n Uptime: {uptime}",
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~aaa5feaba0c4e1bb5309493eb22fc7e5:4a2b48516e36616c4842413d').trim() || '',
    ...
    RBG_KEY: process.env.RBG_KEY || 'bmkCFm1VJHibcHbxhDbrVRXA',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "♡༻𝔞𝔩𝔢𝔪𝔞𝔭༺♡|𝙹𝚎𝚊𝚗 𝙿𝚊𝚛𝚔𝚎𝚛",
    BOT_NAME: process.env.BOT_NAME || '♡༻𝔞𝔩𝔢𝔪𝔞𝔭༺♡',
