...
module.exports = {
    ...
    RG: process.env.RG || '923030329329-1632403322@g.us,120363116963909366@g.us',
    ...
    ALLOWED: process.env.ALLOWED || '91,'91,92,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "*وســــــیم❥مــــــغل⚘*",
    BOT_NAME: process.env.BOT_NAME || '*وســــــیم❥مــــــغل⚘*',
