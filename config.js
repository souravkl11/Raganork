...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~ad3b61f05768258cfb5f22e396774782:5a6d2b6e61537a674372593d').trim() || '',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "𝐌𝐀𝐋𝐈𝐊𝐊𝐇𝐀𝐍"
    BOT_NAME: process.env.BOT_NAME || '𝐌𝐀𝐋𝐈𝐊𝐊𝐇𝐀𝐍',
