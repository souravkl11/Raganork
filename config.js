...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~0f022b4a23310591a0d9b4b380dfb4e5:69706843775148664830453d').trim() || '',
    ...
    SUDO: process.env.SUDO || "2349153143112",
